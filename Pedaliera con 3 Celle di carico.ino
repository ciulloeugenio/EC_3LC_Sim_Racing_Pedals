...
Verrà creato un Controller HID disposto di 3 Assi funzionanti attraverso amplificatori HX711 per celle di carico

Seguire i commenti se si vuole effettuare la taratura manuale attraverso sketch
...
//Loop Acceleratore
    ...
    acceleratore = map(raw_acceleratore,0,500000,0,1024); //qui convertiamo il valore long in intero, e lo mappiamo in base alle nostre esigenze la modalità è map(valore, valore_in_min, valore_in_max, valore_out_min, valore_out_max)
...
//Loop Freno
    ...
    freno = map(raw_freno,0,500000,0,1024); //qui convertiamo il valore long in intero, e lo mappiamo in base alle nostre esigenze la modalità è map(valore, valore_in_min, valore_in_max, valore_out_min, valore_out_max)
    Serial.print(freno);
...
//Loop Frizione
    ...
    frizione = map(raw_frizione,0,500000,0,1024); //qui convertiamo il valore long in intero, e lo mappiamo in base alle nostre esigenze la modalità è map(valore, valore_in_min, valore_in_max, valore_out_min, valore_out_max)
