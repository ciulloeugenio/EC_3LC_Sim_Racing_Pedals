...
const int HX711_dout_3 = 8; //mcu > HX711 no 2 dout pin
const int HX711_sck_3 = 9; //mcu > HX711 no 2 sck pin
...
const int calVal_eepromAdress_4 = 8; // eeprom adress for calibration value load cell 3 (4 bytes)
long t;
...
void setup() {
  ...
  while ((loadcell_1_rdy + loadcell_3_rdy) < 3) { //run startup, stabilization and tare, both modules simultaniously
